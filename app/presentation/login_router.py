...
from .dependencies import get_authentication_service, get_security_monitoring_service
    ...
    try:
        ...
        try:
            ...
            raise HTTPException(
                ...
                headers={"Retry-After": str(lr_exception.retry_after)},
            )
        ...
        if not attempt.successful:
            await security_monitoring_service.record_login_attemp(
